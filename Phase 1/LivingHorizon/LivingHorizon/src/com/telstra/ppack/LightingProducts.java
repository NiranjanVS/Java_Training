...
public class LightingProducts extends Product  {

 Map<Integer,String> catalog = new TreeMap<>();
 Map<Integer,Integer> price = new TreeMap<>();

	LightingProducts() throws FileNotFoundException
	{
		
		Scanner sc1 = new Scanner(new BufferedReader(new FileReader("src\\com\\telstra\\data\\Products\\LightingProduct.txt")));
...
//		catalog.put(1,"Light Bulb");
//		catalog.put(2,"Tube Light");
//		catalog.put(3, "CFL Light");
//		catalog.put(4,"Focus Light");
//		
//		price.put(1, 400);
//		price.put(2, 800);
//		price.put(3, 150);
